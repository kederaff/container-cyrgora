...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-cyrgora.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-cyrgora.containers.anotherwebservice.com/
...
```
git clone git@github.com:kederaff/container-cyrgora.git
cd container-cyrgora
```
...
```
docker attach container-cyrgora
```
